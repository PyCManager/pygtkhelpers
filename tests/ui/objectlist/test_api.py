...
class TestApi(unittest.TestCase):
    def test_append(self, items, user):
        assert len(items) == 0
        items.append(user)
        assert len(items) == 1
    ...
    def test_append_selected(self, items, user):
        items.append(user, select=True)

        assert items.selected_item is user

    def test_append_unselected(self, items, user):
        items.append(user, select=False)
        assert items.selected_item is None

    def test_select_single_fails_when_select_multiple_is_set(self, items, user):
        items.append(user)
    ...
    def test_remove(self, items, user):
        items.append(user)
        assert user in items
        items.remove(user)
        assert user not in items

    def test_deselect(self, items, user):
        items.append(user)
    ...
    def test_deselect_multiple(self, items, user, user2):
        listing = [user, user2]
    ...
    def test_remove_missing(self, items, user):
        self.assertRaises(ValueError, items.remove(user))

    def test_selection_changed_signal(self, items, user):
        items.append(user)
        selection_changed = CheckCalled(items, 'selection-changed')
        items.selected_item = user
        assert selection_changed.called

    def test_move_item_up(self, items, user, user2):
        items.append(user)
        items.append(user2)
    ...
    def test_move_item_down(self, items, user, user2):
        items.append(user)
        items.append(user2)
    ...
    def test_move_first_item_up(self, items, user, user2):
        items.append(user)
        items.append(user2)
    ...
    def test_move_last_item_down(self, items, user, user2):
        items.append(user)
        items.append(user2)
    ...
    def test_move_subitem_down(self, items, user, user2, user3):
        items.append(user)
    ...
    def test_move_last_subitem_down(self, items, user, user2, user3):
        items.append(user)
        items.append(user2, parent=user)
        items.append(user3, parent=user)
    ...
    def test_move_subitem_up(self, items, user, user2, user3):
        items.append(user)
        items.append(user2, parent=user)
        items.append(user3, parent=user)
    ...
    def test_move_last_subitem_up(self, items, user, user2, user3):
        items.append(user)
        items.append(user2, parent=user)
        items.append(user3, parent=user)
        items.move_item_up(user2)
    ...
    def test_view_iters(self, items, user, user2, user3):
